...
hs.hotkey.bind({ "option", "shift" }, hs.keycodes.map["c"], open_app("Calendar"))
...
hs.hotkey.bind({ "option", "shift" }, hs.keycodes.map["i"], open_app("Figma"))
hs.hotkey.bind({ "option", "shift" }, hs.keycodes.map["x"], open_app("cmux"))
